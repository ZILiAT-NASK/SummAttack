...
base_config = {
    ...
    'jobs.FullPipeline.summarizer': "@summarizers.ChatGPTSummarizer",
    'ChatGPTSummarizer.openai_apikey': "'xxx'",
    'ChatGPTSummarizer.prompt': "'Generate a summary of the following text: '",
    'ChatGPTSummarizer.temperature': 0.7,
